...
public class BannerController {
    ...
    @ResponseBody
    @PostMapping("/banner")
    public ResponseEntity<Response> createBanner(@Param("file") MultipartFile file, @Param("url") String link, @Param("size") String size){
        return bannerService.createBanner(file, link, size);
    }

    @ResponseBody
    @PutMapping("/banner/{id}")
    public ResponseEntity<Response> editBanner(@PathVariable("id") Long id, @Param("file") MultipartFile file, @Param("url") String link){
